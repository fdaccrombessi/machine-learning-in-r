---
title: "Housing Picking"
date: "May 8, 2019"
output: html_document
---

#### ML Models used in this example 
- Linear regression Pace and Barry (1997)
...
houses <-  read.table("/Users/teejay/dev/courses/machine-learning-in-r/data/houses_data.txt", header = FALSE, sep = "",dec = ".", row.names = NULL,col.names = c("value",                              "income", "age", "rooms", "bedrooms", "pop", "hh", "latitude", "longitude"))

```

```{r print-first-five-rows}
