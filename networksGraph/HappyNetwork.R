...
## DATA:
## https://drive.google.com/file/d/1Xeae96-u7aPJ9m_Joi7-5c5qvmyX7Y8D/view?usp=sharing

edgeList <- read.table("HappyDataNodes_Edges.csv", header = TRUE, sep = ",")
...
D3_network_LM <- networkD3::forceNetwork(Links = edgeList, # data frame that contains info about edges
                                         ...
                                         linkDistance = networkD3::JS("function(d) { return 40*d.value; }"), # Function to determine distance between any two nodes, uses variables already defined in forceNetwork function (not variables from a data frame)
...
networkD3::saveNetwork(D3_network_LM, "NetD3_Happy.html", selfcontained = TRUE)
